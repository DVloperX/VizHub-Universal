...
local KEY_CONFIG = {
    ...
    -- ─── Цвета (чёрно-оранжевая тема) ───
    AccentColor = Color3.fromRGB(255, 140, 0),      -- оранжевый акцент
    BgColor     = Color3.fromRGB(10, 10, 10),       -- почти чёрный фон
    PanelColor  = Color3.fromRGB(20, 20, 20),       -- чёрные панели
    TextColor   = Color3.fromRGB(245, 245, 245),    -- белый текст
    ErrorColor  = Color3.fromRGB(255, 80, 80),      -- красный
    SuccessColor= Color3.fromRGB(80, 220, 100),     -- зелёный
}
...
CloseBtn.MouseEnter:Connect(function()
    CloseBtn.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
end)
...
SubLbl.TextColor3 = Color3.fromRGB(200, 170, 140)
...
ifStroke.Color = Color3.fromRGB(60, 40, 20)
...
Input.PlaceholderColor3 = Color3.fromRGB(140, 110, 80)
...
local function trySubmit()
    ...
    setStatus("Связь с сервером...", Color3.fromRGB(255, 170, 60))
